...
const images = {
  cafe: withBasePath('/assets/figma/explore-cafe.jpeg'),
  mapPlace: withBasePath('/assets/figma/map-place.jpeg'),
  scene: withBasePath('/assets/figma/explore-scene.jpeg'),
  popup: withBasePath('/assets/figma/explore-popup.png'),
  detail: withBasePath('/assets/figma/place-detail.jpeg'),
  onsite: withBasePath('/assets/figma/onsite-media.png'),
  completePhoto: withBasePath('/assets/figma/complete-photo.png'),
  myMap: withBasePath('/assets/figma/my-map.png'),
};
