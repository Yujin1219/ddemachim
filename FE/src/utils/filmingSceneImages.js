...
export const FILMING_SCENE_DEMO_REFERENCES = [
  {
    url: withBasePath('/assets/scenes/demo/scene-01.jpg'),
    outlineUrl: withBasePath('/assets/scenes/demo/scene-01-outline.svg'),
    width: 960,
    height: 467,
  },
  {
    url: withBasePath('/assets/scenes/demo/scene-02.jpg'),
    outlineUrl: withBasePath('/assets/scenes/demo/scene-02-outline.png'),
    width: 740,
    height: 480,
  },
  {
    url: withBasePath('/assets/scenes/demo/scene-03.jpg'),
    outlineUrl: withBasePath('/assets/scenes/demo/scene-03-outline.png'),
    width: 730,
    height: 486,
  },
  {
    url: withBasePath('/assets/scenes/demo/scene-04.jpg'),
    outlineUrl: withBasePath('/assets/scenes/demo/scene-04-outline.png'),
    width: 919,
    height: 512,
  },
  {
    url: withBasePath('/assets/scenes/demo/scene-05.jpg'),
    outlineUrl: withBasePath('/assets/scenes/demo/scene-05-outline.png'),
    width: 617,
    height: 266,
  },
  {
    url: withBasePath('/assets/scenes/demo/scene-06.jpg'),
    outlineUrl: withBasePath('/assets/scenes/demo/scene-06-outline.png'),
    width: 960,
    height: 456,
  },
];
